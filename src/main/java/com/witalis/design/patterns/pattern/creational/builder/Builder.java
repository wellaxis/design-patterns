...
public class Builder implements IPattern {
     ...
     * Example:
     * --------
     * 1. Class -> Computer [id, name, etc.], private constructor
     * 2. Nested class -> Builder [no fields], private constructor
     * 3. Static method -> static Builder builder() { return new Computer().new Builder() }
     * 4. Builder setter -> Builder setName(String name) { Computer.this.name = name; return this; }
     * 5. Builder build -> public Computer build() { return Computer.this; }
     */
    @Override
    public void process() {
